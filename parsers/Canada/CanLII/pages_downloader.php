...
while(true){
  ...
  curl_setopt($ch, CURLOPT_POSTFIELDS, "aq=(%40sourcedudroit%3D%3DJurisprudence)%20(%40format%3D%3D%22En%20ligne%22)%20(%40sourcedudroit%3D%3DJurisprudence)%20(%40syslanguage%3D%3DFrench)&cq=((%40syscollection%3D%3D(BIBLIO%2CTOPO%2CeDoctrine%2CeLois%2CBVCQ%2CConcerto%2CCanlii))%20(NOT%20%40documentonly))%20(%40recherchable%3D%3D1)&sortCriteria=fielddescending&sortField=%40datenum&searchHub=Recherche&tab=unik&language=fr&firstResult=".$firstResult."&numberOfResults=".$numberOfResults."&excerptLength=400&retrieveFirstSentences=true");
  ...
  foreach($json_result->results as $arret){
    ...
    $url = "https://unik.caij.qc.ca/rest/search/html?pipeline=unik&debug=0&uniqueId=".$uniqid."&errorsAsSuccess=1";
    ...
    $html_file = $dossierArretsHTML."/".$arret->raw->sysfilename;
