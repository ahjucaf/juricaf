  ...
  <main>
    <div class="px-4 py-5 my-5 text-center">
        ...
        <div class="mt-5">
            ...
            <p>Nous sommes désolés de la gêne occasionnées</p>
            <p class="text-muted">Ceci peut être du à l'utilisation de caractères spéciaux lors d'une recherche.</p>
        </div>
    </div>
  </main>
<div class="text-center mt-3">
    <div class="pt-3 px-5 mb-3 clearfix">
      <div class="row">
        <div class="col">
          <a href="https://www.ahjucaf.org/"><img class="img-fluid" src="/images/ahjucaf_small.png" alt="Association des cours judiciaires suprmes francophones" height="86" width="100"/></a>
        </div>
        <div class="col">
          <a href="https://www.francophonie.org/"><img class="img-fluid" src="/images/francophonie_small.png" alt="Organisation internationale de la francophonie" height="86" width="100"/></a>
        </div>
      </div>
    </div>
    <div class="small bottom p-2">
       ...
       <div class="pt-3 p-2">
           <a href="https://iall.org/iall-2012-website-award-winner/"><img src="/images/iall.jpg" height="44" width="224" alt="Logo iall 2012 website award" /></a>
       </div>
    </div>
</div>
</body>
