        ...
        <div class="card-body">
            ...
            <form action="<?php echo url_for('@new_arret'); if ($form->getFileName()) { echo '?arret=' . $form->getFileName(); } ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                            echo $form['PAYS']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Madagascar']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                            echo $form['JURIDICTION']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Cour de cassation']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['DATE_ARRET']->render(['type' => 'date', 'class' => 'form-control', 'placeholder' => 'Ex. : 11/03/1999']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['NUM_ARRET']->render(['class' => 'form-control', 'placeholder' => 'Ex. : 17-HCC/D3']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['FONDS_DOCUMENTAIRE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : HuDoc']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['TYPE_AFFAIRE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Décision (finale)']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['FORMATION']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Première chambre']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['IMPORTANCE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : 1']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['TYPE_RECOURS']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Partiellement irrecevable ; Sursoit à statuer sur la recevabilité du grief mentionné au par. 29 ci-dessus, en attendant les observations écrites du gouvernement défendeur']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['CITATION_ARTICLE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : 21; R17']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['TITRE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Décision n°17-HCC/D3 (Empêchement) Empêchement du Président de la République Juridiction constitutionnelle : compétence (contentieux répressif) : procédure d\'empêchement Chef de l\'Etat : promulgation des lois - responsabilité juridique']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['SOURCE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : http://cmiskp.echr.coe.int/tkp19/view.asp?action=html&documentId=676187']);
                        ?>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="partiesCollapse" class="accordion-collapse collapse" aria-labelledby="partiesHeading">
                            <div class="accordion-body">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="demandeursCollapse" class="accordion-collapse collapse" aria-labelledby="demandeursHeading">
                                            <div class="accordion-body">
                                                ...
                                                <?php echo $form['DEMANDEUR']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Stéphane Roux']); ?>
                                ...
                                <div class="accordion" id="defendeursAccordion">
                                    <div class="accordion-item">
                                        ...
                                        <div id="defendeursCollapse" class="accordion-collapse collapse" aria-labelledby="defendeursHeading">
                                            <div class="accordion-body">
                                                ...
                                                <?php echo $form['DEFENDEUR']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Autorité pour la Valorisation des Actives de l\'Etat']); ?>
                ...
                <div class="accordion" id="analysesAccordion">
                    <div class="accordion-item">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="analyseCollapse" class="accordion-collapse collapse show" aria-labelledby="analyseHeading">
                                            <div class="accordion-body">
                                                ...
                                                <?php echo $form['TITRE_PRINCIPAL']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Révocation - Annulation de la décision - Impossibilité de substituer la décision annulée - Refus de réintégration - Execution sous astreinte impossible - Action en indemnité']); ?>
                                                ...
                                                <?php echo $form['SOMMAIRE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Les jugements rendus dans le cadre de recours en annulation doivent se limiter à annuler les décisions entachées d\'illégalité sans possibilité de remplacer la décision annulée.']); ?>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="referenceCollapse" class="accordion-collapse collapse show" aria-labelledby="referenceHeading">
                                            <div class="accordion-body">
                                                ...
                                                <?php echo $form['TYPE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Source']); ?>
                                                ...
                                                <?php echo $form['REFERENCE_TITRE']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Fichier PDF']); ?>
                                                ...
                                                <?php echo $form['URL']->render(['class' => 'form-control', 'placeholder' => 'Ex. : http://www.juriburkina.org/juriburkina/displayDocument.do?id=3941']); ?>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['PUBLICATION']->render(['class' => 'form-control', 'placeholder' => 'Ex. : Ouvrage : Arrêts de la Chambre Administrative - 50 ans, Cour suprême - Centre de publication et de Documentation Judiciaire - , p.314, (2007)']);
                        ?>
                    </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-8">
                        <?php
                        echo $form['TEXTE_ARRET']->render(['type' => 'textarea', 'class' => 'form-control']);
                        ?>
                    </div>
