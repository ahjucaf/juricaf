<div class="m-5">
<h1 class="py-3">Upload d'arrêt en base</h1>
...
<div class="row g-3 align-items-center <?php if ($form['file']->hasError()): ?>text text-danger<?php endif; ?>">
      <div class="col-3">
    ...
    <div class="text-danger col-9 offset-3" role="alert"><?php echo $form['file']->renderError(); ?></div>
    <?php endif; ?>
</div>
