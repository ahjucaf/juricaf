...
$sf_response->setTitle("Juricaf - Licence ODbL");
?>
<div class="container">
    <ol class="breadcrumb">
    ...
    <h5 class="p-3 mb-2 bg-secondary bg-title fw-bold ">Licence ODbL</h5>
