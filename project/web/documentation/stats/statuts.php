        ...
        <div class="content">
          <div class="form_recherche">
            ...
            <table summary="Rechercher">
              <tr>
                <td>
                  <a href="/recherche"><img id="logo" style="width: 100px; height: 100px;" src="/images/juricaf.png" alt="Juricaf" /></a><br />
                  ...
                  <input type="text" style="width: 300px; margin-top: 2px;" name="q" value="" tabindex="10" /><br />
          ...
          <hr />
          <h1>Statuts et licences des collections</h1>
